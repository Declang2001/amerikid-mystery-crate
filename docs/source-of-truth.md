...
> Status: Entitlement model implemented, purchased flow corrected, 15-hat pool wired, exact preview checkout wired, inventory-aware pool filtering implemented, audio mix balanced (spin 0.35, SFX 0.40/1.0, ambient 0.10/0.05), spin-start variation added.
